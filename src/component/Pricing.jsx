      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto items-center">
          <div className="bg-gray-50 rounded-3xl p-8 border border-gray-100">
            ...
            <button className="btn w-full bg-violet-600 hover:bg-violet-700 text-white border-none rounded-full py-3">Get Started Free</button>
          </div>
          ...
          <div className="bg-violet-600 rounded-3xl p-8 shadow-xl relative transform lg:-translate-y-4 text-white">
            ...
            <ul className="space-y-4 mb-8">
              ...
              <li className="flex items-center gap-3">
                <Check className="w-5 h-5 text-white" /> Priority support
              </li>
              <li className="flex items-center gap-3">
                <Check className="w-5 h-5 text-white" /> Unlimited projects
              </li>
              <li className="flex items-center gap-3">
                <Check className="w-5 h-5 text-white" /> Cloud sync
              </li>
              <li className="flex items-center gap-3">
                <Check className="w-5 h-5 text-white" /> Advanced analytics
              </li>
            </ul>
            <button className="btn w-full bg-white text-violet-600 hover:bg-gray-50 border-none rounded-full py-3">Start Pro Trial</button>
          </div>
          ...
          <div className="bg-gray-50 rounded-3xl p-8 border border-gray-100">
            ...
            <button className="btn w-full bg-violet-600 hover:bg-violet-700 text-white border-none rounded-full py-3">Contact Sales</button>
          </div>
        </div>
      </div>
    </div>
